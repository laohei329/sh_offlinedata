...
public class WarnAllLicsAppMod {
	...
	private WarnAllLicsDTO SimuDataFunc() {
		...
		//证照预警全部证件列表模拟数据
		List<WarnAllLics> warnSchLics = new ArrayList<>();
		//赋值
		...
		//设置数据
		walDto.setWarnAllLics(warnSchLics);
		//分页
	...
	// 证照预警全部证件列表模型函数
	public WarnAllLicsDTO appModFunc(String token, String startWarnDate, String endWarnDate, String distName, String prefCity, String province, String page, String pageSize, Db1Service db1Service, Db2Service db2Service) {
