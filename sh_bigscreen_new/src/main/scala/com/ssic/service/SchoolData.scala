...
object SchoolData {
  ...
  def SchoolInsert(filterData:(RDD[SchoolBean],String,Broadcast[Map[String, String]], Broadcast[Map[String, String]])) = {
    val schoolData = filterData._1.filter(x => x != null
      ...
      && "8627".equals(x.data.district_id)
      && "8637".equals(x.data.district_id)
      && "8636".equals(x.data.district_id)
      && "8638".equals(x.data.district_id)
      && "8640".equals(x.data.district_id)
      && "8639".equals(x.data.district_id)
      && "8641".equals(x.data.district_id)
      && "8642".equals(x.data.district_id)
      && "8643".equals(x.data.district_id)
      && "8630".equals(x.data.district_id)
      && "8628".equals(x.data.district_id)
      && "8629".equals(x.data.district_id)
      && "8631".equals(x.data.district_id)
      && "8633".equals(x.data.district_id)
      && "8634".equals(x.data.district_id)
      && "8635".equals(x.data.district_id))
