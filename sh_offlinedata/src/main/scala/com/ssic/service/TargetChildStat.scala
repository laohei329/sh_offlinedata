...
class TargetChildStat extends TargetChildFunc {
  ...
  override def distributionchild(data: (RDD[(String, String)], RDD[(String, String)], String, RDD[(String, String)])): Unit = {
    ...
    val allSchoolUseDisStatusTotal = allSchoolUse.map(x => (x._1, x._3)).groupByKey().mapValues(x => x.toList.reverse(0)) //每个学校的每个配送操作状态的倒序，取第一个值

    allSchoolUseTotal.leftOuterJoin(allSchoolUseStatusTotal).leftOuterJoin(allSchoolUseDisStatusTotal).map(x => (x._1, (x._2._1._1
      , x._2._1._2.getOrElse("null", -1), x._2._2.getOrElse("null")))).filter(x => x._2._2._2 != -1).filter(x => !"null".equals(x._2._3))
      .map(x => ("area" + "_" + x._1.split("_")(0) + "_" + "id" + "_" + x._1.split("_")(1), (x._2._1, x._2._2, x._2._3))).sortBy(x => x._2._2._1, false)
      .foreachPartition({
        itr =>
          val jedis = JPools.getJedis
          itr.foreach({
            case (k, v) =>
              ...
              if (StringUtils.isNoneEmpty(value) && !value.equals("null")) {
                ...
                if ("3".equals(v._2._1)) {
                  ...
                  jedis.hset(data._3 + "_DistributionTotal_child", k, "total" + "_" + v._1 + "_" + "accept" + "_" + v._2._2 + "_" + "assign" + "_" + v._2._2 + "_" + "shipp" + "_" + v._2._2 + "_" + "status" + "_" + v._2._1 + "_" + "disstatus" + "_" + v._3)

                } else if ("2".equals(v._2._1)) {
                  //待验收
                  jedis.hset(data._3 + "_DistributionTotal_child", k, "total" + "_" + v._1 + "_" + "accept" + "_" + value.split("accept_")(1).split("_")(0) + "_" + "assign" + "_" + (value.split("accept_")(1).split("_")(0).toInt + v._2._2) + "_" + "shipp" + "_" + (value.split("accept_")(1).split("_")(0).toInt + v._2._2) + "_" + "status" + "_" + v._2._1 + "_" + "disstatus" + "_" + v._3)
                }
                else if ("0".equals(v._2._1)) {
                  jedis.hset(data._3 + "_DistributionTotal_child", k, "total" + "_" + v._1 + "_" + "accept" + "_" + value.split("accept_")(1).split("_")(0) + "_" + "assign" + "_" + (value.split("shipp_")(1).split("_")(0).toInt + v._2._2) + "_" + "shipp" + "_" + value.split("shipp_")(1).split("_")(0) + "_" + "status" + "_" + v._2._1 + "_" + "disstatus" + "_" + v._3)
                } else if ("-1".equals(v._2._1)) {
                  jedis.hset(data._3 + "_DistributionTotal_child", k, "total" + "_" + v._1 + "_" + "accept" + "_" + value.split("accept_")(1).split("status")(0) + "status" + "_" + v._2._1 + "_" + "disstatus" + "_" + v._3)
                } else if ("-3".equals(v._2._1)) {
                  jedis.hset(data._3 + "_DistributionTotal_child", k, "total" + "_" + "0" + "_" + "accept" + "_" + "0" + "_" + "assign" + "_" + "0" + "_" + "shipp" + "_" + "0" + "_" + "status" + "_" + "-1" + "_" + "disstatus" + "_" + v._3)
                }
              } else {
                if ("3".equals(v._2._1)) {
                  jedis.hset(data._3 + "_DistributionTotal_child", k, "total" + "_" + v._1 + "_" + "accept" + "_" + v._2._2 + "_" + "assign" + "_" + v._2._2 + "_" + "shipp" + "_" + v._2._2 + "_" + "status" + "_" + v._2._1 + "_" + "disstatus" + "_" + v._3)
                  ...
                  jedis.hset(data._3 + "_DistributionTotal_child", k, "total" + "_" + v._1 + "_" + "accept" + "_" + "0" + "_" + "assign" + "_" + v._2._2 + "_" + "shipp" + "_" + v._2._2 + "_" + "status" + "_" + v._2._1 + "_" + "disstatus" + "_" + v._3)
                } else if ("0".equals(v._2._1)) {
                  jedis.hset(data._3 + "_DistributionTotal_child", k, "total" + "_" + v._1 + "_" + "accept" + "_" + "0" + "_" + "assign" + "_" + v._2._2 + "_" + "shipp" + "_" + "0" + "_" + "status" + "_" + v._2._1 + "_" + "disstatus" + "_" + v._3)
                } else if ("-1".equals(v._2._1)) {
                  jedis.hset(data._3 + "_DistributionTotal_child", k, "total" + "_" + v._1 + "_" + "accept" + "_" + "0" + "_" + "assign" + "_" + "0" + "_" + "shipp" + "_" + "0" + "_" + "status" + "_" + v._2._1 + "_" + "disstatus" + "_" + v._3)
  ...
  override def retentionchild(data: (RDD[(String, String)], RDD[(String, String, String, String)], String, RDD[(String, String)])): Unit = {

    //(area, liuyang, schoolid,reservestatus)
    val retentionData = data._2.map(x => (x._1 + "_" + x._3, x._2 + "_" + x._4))
      ...
      x =>
        ...
        if ("null".equals(distributionList)) {
          ...
          if ("已留样".equals(distributionList.split("_")(0))) {
            (x._1, "1", distributionList.split("_")(1))
          } else {
            (x._1, "0", distributionList.split("_")(1))
          }
        }
    })
    ...
    val retendealstatusdata = allSchoolUse.map(x => (x._1, x._3)).groupByKey().mapValues(x => x.toList.reverse(0)) //各学校的留样操作状态的倒序，取第一个值

    retenTotal.leftOuterJoin(retenstatdata).leftOuterJoin(retendealstatusdata).map(x => (x._1, (x._2._1._1, x._2._1._2.getOrElse(("null", -1)), x._2._2.getOrElse("null")))).filter(x => x._2._2._2 != -1).filter(x => !"null".equals(x._2._3))
        ...
        itr.foreach({
          case (k, v) =>
            ...
            if (v._1.size == 0) {
              ...
              if ("-1".equals(v._1.head._2._1)) {
                //该学校没有留样计划
                jedis.hset(data._3 + "_gc-retentiondishtotal_child", k, "total" + "_" + "0" + "_" + "reserve" + "_" + "0" + "_" + "noreserve" + "_" + "0" + "_" + "status" + "_" + "0" + "_" + "reservestatus" + "_" + "4")
              } else {
                //该学校有留样计划
                if ("0".equals(v._1.head._2._1)) {
                  if (v._1.head._2._2 != 0) {
                    jedis.hset(data._3 + "_gc-retentiondishtotal_child", k, "total" + "_" + v._1.head._1 + "_" + "reserve" + "_" + (v._1.head._1 - v._1.head._2._2) + "_" + "noreserve" + "_" + v._1.head._2._2 + "_" + "status" + "_" + "0" + "_" + "reservestatus" + "_" + "4")
                  } else {
                    jedis.hset(data._3 + "_gc-retentiondishtotal_child", k, "total" + "_" + v._1.head._1 + "_" + "reserve" + "_" + (v._1.head._1 - v._1.head._2._2) + "_" + "noreserve" + "_" + v._1.head._2._2 + "_" + "status" + "_" + "1" + "_" + "reservestatus" + "_" +v._1.head._3)
                  }

                } else {
                  if ((v._1.head._1 - v._1.head._2._2) != 0) {
                    jedis.hset(data._3 + "_gc-retentiondishtotal_child", k, "total" + "_" + v._1.head._1 + "_" + "reserve" + "_" + v._1.head._2._2 + "_" + "noreserve" + "_" + (v._1.head._1 - v._1.head._2._2) + "_" + "status" + "_" + "0" + "_" + "reservestatus" + "_" + "4")
                  } else {
                    jedis.hset(data._3 + "_gc-retentiondishtotal_child", k, "total" + "_" + v._1.head._1 + "_" + "reserve" + "_" + v._1.head._2._2 + "_" + "noreserve" + "_" + (v._1.head._1 - v._1.head._2._2) + "_" + "status" + "_" + "1" + "_" + "reservestatus" + "_" +v._1.head._3)
                  }
