...
trait RetentionTotalFunc {
  ...
  //各区留样计划总数据统计
  def arearetentiontotal(data:(RDD[(String, String,String,String, String)],String))

  //按照管理权限各区留样计划统计数据
  def departmentarearetentiontotal(data:(RDD[(String, String,String,String, String)],String,Broadcast[Map[String, List[String]]]))

  //各区留样计划各状态数据统计
  def arearetentionstatustotal(data:(RDD[(String, String,String,String, String)],String,RDD[(String, String)]))

  //按照权限各区留样计划各状态数据统计
  def departmentarearetentionstatustotal(data:(RDD[(String, String,String,String, String)],String,Broadcast[Map[String, List[String]]]))

  //各区留样操作规则数据统计
  def arearetentionrulestatustotal(data:(RDD[(String, String,String,String, String)],String,RDD[(String, String)]))

  //按照权限的各区留样操作规则数据统计
  def departmentarearetentionrulestatustotal(data:(RDD[(String, String,String,String, String)],String, Broadcast[Map[String, List[String]]]))
  ...
  //按所属教育部留样计划各状态数据统计
  def masteridretentiontotal(data:(RDD[(String, String,String,String, String)],String,RDD[(String, String)],Broadcast[Map[String, List[String]]],Broadcast[Map[String,String]]))

  //按照权限的所属留样计划各状态数据统计
  def departmentmasteridretentiontotal(data:(RDD[(String, String,String,String, String)],String,Broadcast[Map[String, List[String]]],Broadcast[Map[String,String]]))

  //按所属教育部留样操作规则数据统计
  def masteridretentionruletotal(data:(RDD[(String, String,String,String, String)],String,RDD[(String, String)],Broadcast[Map[String, List[String]]],Broadcast[Map[String,String]]))

  //按权限所属教育部留样操作规则数据统计
  def departmentmasteridretentionruletotal(data:(RDD[(String, String,String,String, String)],String,Broadcast[Map[String, List[String]]],Broadcast[Map[String,String]]))
  ...
  def natureretentionstatus(data:(RDD[(String, String,String,String, String)],String,RDD[(String, String)],Broadcast[Map[String, List[String]]]))

  //按权限上海市办学性质来留样计划各状态数据统计（nature）
  def departmentnatureretentionstatus(data:(RDD[(String, String,String,String, String)],String,Broadcast[Map[String, List[String]]]))

  //按上海市办学性质来留样操作规则各状态数据统计（nature）
  def natureretentionrulestatus(data:(RDD[(String, String,String,String, String)],String,RDD[(String, String)],Broadcast[Map[String, List[String]]]))

  //按权限上海市办学性质来留样操作规则各状态数据统计（nature）
  def departmentnatureretentionrulestatus(data:(RDD[(String, String,String,String, String)],String,Broadcast[Map[String, List[String]]]))

  //各区办学性质来留样计划各状态数据统计（nature）
  def areanatureretentionstatus(data:(RDD[(String, String,String,String, String)],String,RDD[(String, String)],Broadcast[Map[String, List[String]]]))
  ...
  def levelreretentionstatus(data:(RDD[(String, String,String,String, String)],String,RDD[(String, String)],Broadcast[Map[String, List[String]]]))

  //按权限上海市各类型学校来留样计划各状态数据统计（level）
  def departmentlevelreretentionstatus(data:(RDD[(String, String,String,String, String)],String,Broadcast[Map[String, List[String]]]))

  //按上海市各类型学校来留样操作规则数据统计（level）
  def levelreretentionrulestatus(data:(RDD[(String, String,String,String, String)],String,RDD[(String, String)],Broadcast[Map[String, List[String]]]))

  //按权限上海市各类型学校来留样操作规则数据统计（level）
  def departmentlevelreretentionrulestatus(data:(RDD[(String, String,String,String, String)],String,Broadcast[Map[String, List[String]]]))

  //按各区各类型学校来留样计划各状态数据统计（level）
  def arealevelreretentionstatus(data:(RDD[(String, String,String,String, String)],String,RDD[(String, String)],Broadcast[Map[String, List[String]]]))
  ...
  //按管理部门留样计划各状态数据统计
  def departmentstatus(data:(RDD[(String, String,String,String, String)],String,RDD[(String, String)],Broadcast[Map[String, List[String]]]))

  //按权限管理部门留样计划各状态数据统计
  def departmentdepartmentstatus(data:(RDD[(String, String,String,String, String)],String,Broadcast[Map[String, List[String]]]))

  //按管理部门留样计划操作规则统计
  def departmentrulestatus(data:(RDD[(String, String,String,String, String)],String,RDD[(String, String)],Broadcast[Map[String, List[String]]]))

  //按权限管理部门留样计划操作规则统计
  def departmentdepartmentrulestatus(data:(RDD[(String, String,String,String, String)],String,Broadcast[Map[String, List[String]]]))
  ...
  def departmentareanatureretentionstatus(data:(RDD[(String, String,String,String,String)],String,Broadcast[Map[String, List[String]]]))

  //按权限各区各类型学校来留样计划各状态数据统计（level）

  def departmentarealevelreretentionstatus(data:(RDD[(String, String,String,String,String)],String,Broadcast[Map[String, List[String]]]))
