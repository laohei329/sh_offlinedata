...
object SaveOnRedis {
  ...
  def PlatoonPlanReal(itr:Iterator[(String,String,String,String,String,String,String,String,String)]) = {
    val jedis = JPools.getJedis
    itr.foreach({
      x =>
          if("delete".equals(x._9)){
            jedis.hdel(x._1+"_"+"platoon",x._2+"_"+x._3)
          } else{
            jedis.hset(x._1+"_"+"platoon",x._2+"_"+x._3,"1")
          }
//        if(jedis.exists(x._1+ "_" + "platoon").equals(true)){
//          val hkeys: util.Set[String] = jedis.hkeys(x._1+"_"+"platoon")
//          if(hkeys.asScala.contains(x._2+"_"+x._3).equals(true)){
//            logger.info("这个学校已经排除了，不计算！")
//          }else{
//            jedis.hset(x._1+"_"+"platoon",x._2+"_"+x._3,"1")
//            jedis.hincrBy(x._1+"_"+"platoon-total","area"+"_"+x._2,1)
//            jedis.hincrBy(x._1+"_"+"platoon-total","shanghai",1)
//
//
//            jedis.hincrBy(x._1+"_"+"platoon-total","shanghai-nature"+"_"+x._5+"_"+"nature-sub"+"_"+x._7,1)
//            jedis.hincrBy(x._1+"_"+"platoon-total","shanghai-canteenMode"+"_"+x._4+"_"+"ledgertype"+"_"+x._8,1)
//            jedis.hincrBy(x._1+"_"+"platoon-total","shanghai-level"+"_"+x._6,1)   //学校类型
//          }
//        }else{
//          jedis.hset(x._1+"_"+"platoon",x._2+"_"+x._3,"1")
//          jedis.hincrBy(x._1+"_"+"platoon-total","area"+"_"+x._2,1)
//          jedis.hincrBy(x._1+"_"+"platoon-total","shanghai",1)
//          jedis.hincrBy(x._1+"_"+"platoon-total","shanghai-nature"+"_"+x._5+"_"+"nature-sub"+"_"+x._7,1)            //学校性质
//          jedis.hincrBy(x._1+"_"+"platoon-total","shanghai-canteenMode"+"_"+x._4+"_"+"ledgertype"+"_"+x._8,1)   //经营模式
//          jedis.hincrBy(x._1+"_"+"platoon-total","shanghai-level"+"_"+x._6,1)   //学校类型
//        }
    })
  }
  ...
  //配送计划的详细的计算
  def DistributionDetailRealTime(itr: Iterator[(String, String, String, String, String, String, String, String, String, String, String)]) = {
    val jedis = JPools.getJedis
    itr.foreach({
      x =>
        //id,配送时间，配送类型，学校ID，团餐公司ID，发货批次，配送状态，统配,区号，表类型，stat
        ...
        if (jedis.exists(x._2 + "_" + "DistributionDetail").equals(true)) {
          ...
          for (i <- strings.asScala) {
            ...
            if("insert".equals(x._10) && "1".equals(x._11)){
              if(StringUtils.isNoneEmpty(x._8) && !x._8.equals("null")){
                jedis.hset(x._2 + "_" + "DistributionDetail", "id"+"_"+x._1 +"_"+"type"+ "_" + x._3+"_"+"schoolid"+"_" + x._4+"_"+"area"+"_"+x._9 +"_"+"sourceid"+ "_" + x._5 + "_" +"batchno"+"_"+ x._6 +"_"+"delivery"+ "_" + x._8, x._7)
              }else{
                jedis.hset(x._2 + "_" + "DistributionDetail", "id"+"_"+x._1 +"_"+"type"+ "_" + x._3+"_"+"schoolid"+"_" + x._4+"_"+"area"+"_"+x._9 +"_"+"sourceid"+ "_" + x._5 + "_" +"batchno"+"_"+ x._6 +"_"+"delivery"+ "_" + "直配", x._7)
              }
              ...
              if(id.equals("id_"+x._1)){
                if("0".equals(x._11)){
                  ...
                  jedis.hset(x._2 + "_" + "DistributionDetail", i,x._7)
                }
              }
