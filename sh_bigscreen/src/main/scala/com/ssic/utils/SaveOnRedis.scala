...
object SaveOnRedis {
  ...
  def PlatoonPlanReal(itr:Iterator[(String,String,String,String,String,String,String,String,String,String)]) = {
    ...
    itr.foreach({
      x =>
          if("delete".equals(x._9)){
            ...
            jedis.hset(x._1+"_"+"platoon",x._2+"_"+x._3,"1"+"_"+"create-time"+"_"+x._10)
          }
